...
if (typeof window !== 'undefined') {
  ...
  return (
    <nav className="sticky left-0 top-0 z-40 w-full sm:top-6">
      <div className="mx-auto flex max-w-5xl items-center justify-between border-b border-zinc-200 dark:border-gray-700 bg-white dark:bg-black bg-opacity-50 p-4 py-2 text-sm backdrop-blur transition-colors duration-150 sm:rounded-lg sm:border lg:px-6">
